...
public class CustomerController extends HttpServlet {
	...
	private void addCustomer(HttpServletRequest request, HttpServletResponse response)
		...
		if (accountNumber == null || accountNumber.isEmpty() || name == null || name.isEmpty() || address == null
				|| address.isEmpty() || telephone == null || telephone.isEmpty() || email == null || email.isEmpty()) {
	...
	private void updateCustomer(HttpServletRequest request, HttpServletResponse response)
		...
		if (idStr == null || idStr.isEmpty() || accountNumber == null || accountNumber.isEmpty() || name == null
				|| name.isEmpty() || address == null || address.isEmpty() || telephone == null || telephone.isEmpty()
