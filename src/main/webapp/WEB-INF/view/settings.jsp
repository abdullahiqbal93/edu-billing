    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <% com.pahana.model.User currUser=(com.pahana.model.User) session.getAttribute("user"); boolean
                    isSuperAdmin=currUser !=null && "SUPER_ADMIN" .equals(currUser.getRole()); if (isSuperAdmin) { %>
                    ...
                    <% } %>
                        ...
                        <section id="account-section" class="content-section active">
                            <div class="section-header">
                                ...
                                <% com.pahana.model.User loggedInUser=(com.pahana.model.User)
                                    session.getAttribute("user"); if (loggedInUser !=null && loggedInUser.getUsername()
                                    !=null) { %>
                                    <p class="section-description">Signed in as: <strong>
                                ...
                                <div class="settings-card username-card">
                                    ...
                                    <form method="post" action="settings" class="card-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="newUsername" class="form-input"
